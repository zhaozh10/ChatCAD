...
from models.detection import get_hourglass
from models.segmentation import ToothInstanceSegmentation
from models.classification import DenseNet, densenet161
from utils import ctdet_decode, gaussian_map, exp_tem, crop
...
img_path = './pan/periodontals/Subject No.338.jpg'
config = {

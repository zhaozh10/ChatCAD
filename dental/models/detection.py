...
class exkp(nn.Module):
  def __init__(self, n, nstack, dims, modules, in_c = 1, cnv_dim=256, num_classes=80):
    ...
    self.pre = nn.Sequential(convolution(7, in_c, 128, stride=2),
...
get_hourglass = \
  {'large_hourglass':
     exkp(n=5, nstack=2, dims=[256, 256, 384, 384, 384, 512], modules=[2, 2, 2, 2, 2, 4], num_classes=32, in_c=1),
   'small_hourglass':
     exkp(n=5, nstack=1, dims=[256, 256, 384, 384, 384, 512], modules=[2, 2, 2, 2, 2, 4], num_classes=32, in_c=1)}
